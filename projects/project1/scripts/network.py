"""network.py
~~~~~~~~~~~~~~
Implementation of basic perceptron neural network
...
class Network(object):
    def __init__(self, sizes, cost=CrossEntropyCost):
        ...
        self.cost = cost
        # Modify this network to support the momentum Gradient Descent.
    ...
    def velocity_initializer(self):
        """ This is a function to set initial velocities to 0, for biases and
        weights.
        :return: nothing
        """
        ## Note!! the data structure shall be aligned, if narray, then all array
        ## If list, then all list.
                ...
                if monitor_no_imrpove:
                    ...
                    if best_in_n_counter >= no_improve:
                        if monitor_halve_learning_rate:
                            ...
                            print("Accuracy is not improving for last \
                            %s epochs" % no_improve)
                            break
